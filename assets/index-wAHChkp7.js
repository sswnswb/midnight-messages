...
可我认得你。`,["typing"],[{label:"你是谁？",go:"c1s1",flags:{askWho:!0}},{label:"*不回。盯着屏幕。",go:"c1s1"}])]},_=(e,t,n,o,a,s)=>({id:e,speaker:t,text:n,effects:o,choices:a,next:s}),jn={nodes:[_("c1s1","number",`我是谁不重要。
...
「我们」之后的那一天。`,["typing","drafts"],void 0,"c4s13d"),p("c4s13d","narration","草稿箱需要 4 位数字密码。",[],[{label:"*去解锁草稿箱",cond:"!flag:draftsUnlocked",effect:["screen:drafts"],go:"c4s13d"},{label:"我打开了，都看完了。",cond:"flag:draftsUnlocked",go:"c4s15",flags:{sawDrafts:!0},effect:["count:trait_truth"]},{label:"*先记下这个谜题，想想再回来",go:"c4s13d"}]),p("c4s14","number",`你拉黑了我。
...
那是你唯一逃不掉的日子。`,["typing"],[{label:"*回到草稿箱，解锁它",cond:"!flag:draftsUnlocked",effect:["screen:drafts"],go:"c4s13d"},{label:"我打开了，都看完了。",cond:"flag:draftsUnlocked",go:"c4s15",flags:{sawDrafts:!0},effect:["count:trait_truth"]}]),p("c4s15","number",`看完了？
