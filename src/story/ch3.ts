...
export const ch3: Chapter = {
  ...
  nodes: [
    ...
    N('c3s11', 'narration', '你看了下时间。\n\n凌晨 3:33。\n\n屏幕自己亮了。相册……好像，多了一张照片。', ['time:213', 'flag:night333', 'banner:3:33 —— 相册里好像多了一张照片', 'sting'], undefined, 'c3s11w'),
    ...
    N('c3s12', 'number', '3:33 的照片，你看到了吧。\n\n那不是别人。\n\n那是你忘了的她。也是你忘掉的自己。', ['typing', 'stinglong', 'presence'], undefined, 'c3s13'),
    N('c3s13', 'number', '明天，我给你看那晚的照片。\n\n然后，你要做一个决定。', ['typing'], [
