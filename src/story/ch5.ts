...
export const ch5: Chapter = {
  ...
  nodes: [
    ...
    N('c5s2', 'number', '最后一夜了。王斌。', ['typing', 'sfx:msg_num'], undefined, 'c5s2a'),
    N('c5s2a', 'number', '第一夜，你还没发现我。第二夜，你开始查我的日期。第三夜，你等到 3:33，看见了那张照片。\n\n第四夜，你拼出了那晚的顺序。\n\n这一年来，你一点一点，走回来了。', ['typing', 'sting'], undefined, 'c5s3'),
    N('c5s3', 'number', '一年了。每天 00:00，我都在这里等你。\n\n现在你都想起来了。\n\n所以——轮到你回答了。', ['typing'], undefined, 'c5s3a'),
    N('c5s3a', 'number', '你收集了 {evidence_count} 件证据。\n\n我知道你不是故意要躲的。\n\n你只是……怕。', ['typing'], undefined, 'c5s4'),
    ...
    N('c5s6t', 'narration', '你打出了那行字，发送。\n\n然后，你拨出了那个号码。\n\n号码没有再回。', ['sfx:send', 'time:5'], undefined, 'c5s7t'),
    N('c5s7t', 'narration', '你穿上外套。门打开的那一刻，雨小了很多。\n\n你没有回头。手机安安静静地躺在口袋里。', ['sfx:send'], undefined, undefined, 'ending:resolve'),
    N('c5s6h', 'narration', '你找到了陈医生的名片，拨了过去。\n\n电话响了三声，接通了。\n\n你说：医生，我想聊聊。', ['sfx:ring', 'time:5'], undefined, 'c5s7h'),
    N('c5s7h', 'narration', '那通电话打了很久。\n\n挂断的时候，你发现自己哭了，却觉得轻松。\n\n窗外，雨停了。', ['sfx:ring'], undefined, undefined, 'ending:resolve'),
    N('c5s6c', 'narration', '你翻开相册，找到那张蛋糕照片。\n\n蜡烛的光，照着你一个人的脸。\n\n你忽然明白，这一年你真正怕的是什么。', ['sfx:breath', 'time:5'], undefined, 'c5s7c'),
    N('c5s7c', 'narration', '你没有关掉相册。\n\n就那么看着，直到天亮。\n\n原来记得，比忘掉需要更多勇气。', ['sfx:breath'], undefined, undefined, 'ending:resolve'),
    N('c5s6a', 'narration', '你删除了所有聊天记录，拉黑号码，清空了草稿箱。\n\n手机恢复出厂设置的那一刻，你长长地舒了一口气。', ['sfx:send', 'time:5', 'sting'], undefined, 'c5s7a'),
    N('c5s7a', 'narration', '清晨，你把新手机开机。\n\n桌面干干净净。\n\n你盯着那部新手机，忽然觉得，少了点什么。', ['sfx:send'], undefined, undefined, 'ending:resolve'),
    N('c5s6s', 'narration', '你没有回。\n\n屏幕暗下去，又因为新消息亮起来。你没有看。\n\n天亮了。你也没有看。', ['time:420', 'sting'], undefined, undefined, 'ending:resolve'),
  ],
};
